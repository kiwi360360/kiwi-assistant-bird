...
//()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()
const kwaDivV = document.createElement('div');
kwaDivV.setAttribute('id', 'kwaDivV');
kwaDivV.setAttribute('title', '「『網奇』鳥助」自動作答以載入題目');
kwaDivV.setAttribute('onclick', 'ans_robott()');
kwaDivV.style.position = 'fixed';
kwaDivV.style.bottom = '145px';
kwaDivV.style.left = '0px';
kwaDivV.style.background = 'white';
kwaDivV.style.width = '40px';
kwaDivV.style.height = '40px';
kwaDivV.style.padding = '5px';
kwaDivV.innerHTML = `<div id='BtnV'></div>`;
document.body.appendChild(kwaDivV)
//()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()
...
kwaStyleO.innerHTML = `
    ...
    #BtnV {
        ...
        border-radius: 50%;
        background-size: 100%;
        background-image: url('https://1.bp.blogspot.com/-YhXPbrPVMK4/YHuY9de8I3I/AAAAAAAALzA/g8B2QHveA3YAhWptp76UTDNp45Se8_RVACLcBGAsYHQ/s2048/IMG_3380.PNG');
    }
    `;
...
if (location.pathname == '/2019_beta/login.php') {
    ...
    function kwaBtn2Click() {
        ...
        if (kwu == 123456) {
            document.getElementById('useraccount').setAttribute('value', '123456');
            checkinput();
            document.getElementById('userpwd').setAttribute('value', '7890');
        }
...
function ans_robot() {
    ...
    var anspp = 0
    for (ansx = 1; ansx <= QV.Qtotal; ansx += 1) {
        ansy = ansy + QV.QData[1][ansx][2]
        if (QV.QData[1][ansx][2] == 1) {
            anspp = anspp + 1
        }
    }
    for (ansx = 1; ansx <= QV.Qtotal; ansx += 1) {
    ...
    if (ansy == QV.Qtotal) {
        ...
        return anspp/QV.Qtotal
    }
}
kwaBtnClick()
function kwaBtnClick() {
    //QV.QData[1][2] = [2, "QBase/E42/E42A140", 1, 0, 0]//http://kiwi.nssh.ntpc.edu.tw/2019_beta/writescore/writeans.php?anstime=00:00:30&classnum=CC2&Q=1_Kn/0_G21
    //GV.userIOKey[0][2] = 1
    QV.TimeTotal = 36000
